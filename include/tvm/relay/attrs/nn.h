...
/*! \brief Attributes used in convolution operators */
struct AmmConv2DAttrs : public tvm::AttrsNode<AmmConv2DAttrs> {
  Array<IndexExpr> subvec_len; 
  ...
  TVM_DECLARE_ATTRS(AmmConv2DAttrs, "relay.attrs.AmmConv2DAttrs") {
    TVM_ATTR_FIELD(subvec_len)
    .describe(
        "Spicifies the length of AMM subvector");
    
    TVM_ATTR_FIELD(output_shape)
        .describe("Specifies the output shape of the convolution.")
        .set_default(NullValue<Array<IndexExpr>>());
...
/*! \brief Attributes used in convolution operators */
struct AmmLinearAttrs : public tvm::AttrsNode<AmmLinearAttrs> {
  Array<IndexExpr> subvec_len; 
  Array<IndexExpr> output_shape;
  DataType out_dtype;
...
/*! \brief Attributes used in convolution operators */
struct AmmConv2DInt8Attrs : public tvm::AttrsNode<AmmConv2DInt8Attrs> {
  Array<IndexExpr> subvec_len; 
  Array<IndexExpr> output_shape;
  Array<IndexExpr> kernel_size; 
  Array<IndexExpr> strides;
  ...
  TVM_DECLARE_ATTRS(AmmConv2DInt8Attrs, "relay.attrs.AmmConv2DAttrs") {
    TVM_ATTR_FIELD(subvec_len)
    .describe(
        "Spicifies the length of AMM subvector");
...
/*! \brief Attributes used in convolution operators */
struct AmmLinearInt8Attrs : public tvm::AttrsNode<AmmLinearInt8Attrs> {
  Array<IndexExpr> subvec_len; 
  Array<IndexExpr> output_shape;
  DataType out_dtype;

  TVM_DECLARE_ATTRS(AmmConv2DInt8Attrs, "relay.attrs.AmmConv2DInt8Attrs") {
    TVM_ATTR_FIELD(subvec_len)
    .describe(
        "Spicifies the length of AMM Int8 subvector");
